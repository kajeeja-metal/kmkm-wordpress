...
if ( ! class_exists( 'SP_Admin' ) ) :
	...
	class SP_Admin {
		...
		public function plugin_links( $links ) {
			$plugin_links = array(
				'<a href="http://support.woothemes.com/">' . __( 'Support', 'storefront-powerpack' ) . '</a>',
				'<a href="http://docs.woothemes.com/document/storefront-powerpack/">' . __( 'Docs', 'storefront-powerpack' ) . '</a>',
			);
