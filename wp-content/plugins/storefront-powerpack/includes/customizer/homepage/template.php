...
if ( ! function_exists( 'sp_homepage_product_section_view_more_button' ) ) {
	...
	function sp_homepage_product_section_view_more_button( $setting, $label ) {
		...
		if ( '' !== $url ) {
			echo '<p class="clearfix text-center"><a href="' . esc_url( $url ) . '" class="button btn-main">' . esc_attr__( $label, 'storefront-powerpack' ) . '</a></p>';
		}
	}
}
...
if ( ! function_exists( 'sp_homepage_best_selling_products_view_more' ) ) {
	...
	function sp_homepage_best_selling_products_view_more() {
		// sp_homepage_product_section_view_more_button( 'sp_homepage_best_sellers_products_more_url', __( 'View Products', 'storefront-powerpack' ) );
	}
}
