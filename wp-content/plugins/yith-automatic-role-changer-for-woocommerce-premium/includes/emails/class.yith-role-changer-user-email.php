	...
	class YITH_Role_Changer_User_Email extends WC_Email {
		...
		public function init_form_fields() {
			$this->form_fields = array(
				...
				'email_type' => array(
					'title'       => __( 'Email type', 'yith-automatic-role-changer-for-woocommerce' ),
					'type'        => 'select',
					'description' => __( 'Choose which format of email to send.', 'yith-automatic-role-changer-for-woocommerce' ),
					'default'     => 'html',
