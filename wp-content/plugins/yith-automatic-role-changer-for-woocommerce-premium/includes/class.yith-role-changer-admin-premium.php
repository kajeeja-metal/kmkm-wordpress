            ...
            <div class="rule_radio_group block radio_group">
                ...
                <p>
                    <label for="ywarc_rule_radio_range[<?php echo $rule_id; ?>]">
                        ...
                        ?>><?php echo __( 'Order total is within the following price range',
                            'yith-automatic-role-changer-for-woocommerce' ); ?>
                    </label>
                </p>
                <p>
                    <label for="ywarc_rule_radio_overall_range[<?php echo $rule_id; ?>]">
			            ...
			            ?>><?php echo __( "Customer's total spend falls within the following price range",
				            'yith-automatic-role-changer-for-woocommerce' ); ?>
                    </label>
                </p>
                <p>
	    ...
	    public function enqueue_scripts( $hook_suffix ) {
		    ...
		    wp_localize_script( 'ywarc-admin', 'localize_js_ywarc_admin',
			    array(
				    ...
				    'force_apply_rules_warning' => __( 'Are you sure you want to apply this action? This cannot be undone.', 'yith-automatic-role-changer-for-woocommerce' ),
				    'force_apply_all_rules' => __( 'All the orders with valid rules will be processed and assign/switch user roles automatically.', 'yith-automatic-role-changer-for-woocommerce' ),
				    'force_apply_date_range_rules' => __( 'All orders with valid rules between {date_from} and {date_to} will be processed and will assign/switch user roles automatically.', 'yith-automatic-role-changer-for-woocommerce' ),
				    'force_apply_date_from_rules' => __( 'All the orders with valid rules since {date_from} will be processed and will assign/switch user roles automatically.', 'yith-automatic-role-changer-for-woocommerce' ),
				    'force_apply_date_to_rules' => __( 'All the orders with valid rules until {date_to} will be processed and will assign/switch user roles automatically.', 'yith-automatic-role-changer-for-woocommerce' ),
				    'force_apply_rules_dates_warning' => __( 'Warning: "From" field must not be greater than "To" field', 'yith-automatic-role-changer-for-woocommerce' )
			    )
		    );
	    }
