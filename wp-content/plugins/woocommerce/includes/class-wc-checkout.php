		...
		$this->fields = array(
			...
			'order'    => array(
				'order_comments' => array(
					'type'        => 'textarea',
					'class'       => array( 'notes' ),
					'label'       => __( '<span style="display:block;"><b>Order notes</b><BR><BR>1. ต้องการใบกำกับภาษี แบบบุคคลธรรมดา กรุณากรอกข้อมูลต่อไปนี้ให้ครบถ้วนคำนำหน้าชื่อ ชื่อ นามสกุล  เลขประจำตัวผู้เสียภาษีอากรที่อยู่ ถนน แขวง/ตำบล เขต/อำเภอ จังหวัด ประเทศ รหัสไปรษณีย์ เบอร์โทรศัพท์<BR><BR>
						2. ต้องการใบกำกับภาษี แบบนิติบุคคล กรุณากรอกข้อมูลต่อไปนี้ให้ครบถ้วน
						ชื่อนิติบุคคล (สำนักงาน/สาขา) เลขประจำตัวผู้เสียภาษีอากร
						ที่อยู่ ถนน แขวง/ตำบล เขต/อำเภอ จังหวัด ประเทศ รหัสไปรษณีย์ เบอร์โทรศัพท์</span><BR>', 'woocommerce' ),
