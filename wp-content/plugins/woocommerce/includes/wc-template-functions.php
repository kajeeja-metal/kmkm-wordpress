...
function wc_get_gallery_image_html( $attachment_id, $main_image = false ) {
	...
	return '
	<div data-thumb="' . esc_url( $thumbnail_src[0] ) . '" class="woocommerce-product-gallery__image">
		<a href="' . esc_url( $alt_text ) . '">
			<div class="images-products" style="background-image:url(' . $full_src[0] . ');"></div>
		</a>
	</div>
	';
}
