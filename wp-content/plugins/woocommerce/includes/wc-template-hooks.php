...
/**
 * After Related Products Summary Div.
 *
 * @see woocommerce_output_related_products() edit hook
 */
add_action( 'woocommerce_related_single_product_summary', 'woocommerce_output_related_products', 20 );
/**
 * Product Summary Box.
 *
...
add_action( 'woocommerce_before_checkout_coupons_form', 'woocommerce_checkout_coupon_form', 10 );
