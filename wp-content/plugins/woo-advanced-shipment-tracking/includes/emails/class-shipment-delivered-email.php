...
if ( ! class_exists( 'WC_Email_Customer_Delivered_Order', false ) ) :
	...
	class WC_Email_Customer_Delivered_Order extends WC_Email {
		...
		public function __construct() {
			...
			$this->description    = __( 'Order delivered emails are sent to customers when their orders are marked delivered and usually indicate that their orders have been shipped.', 'woocommerce' );
		...
		*/
		...
		public function get_default_subject() {
			return __( 'Your {site_title} order is now delivered', 'woocommerce' );
		}
		...
		public function init_form_fields() {
			$this->form_fields = array(
				...
				'display_premium_options1' => array(
					'type'			=> 'title',
					'description'	=> __( '<a href="'.wcast_initialise_customizer_email::get_customizer_url('customer_delivered_email').'" >Click Here</a>', 'woocommerce-advanced-sales-report-email' ),
					'title'			=> __( 'Edit in customizer', 'woocommerce-advanced-sales-report-email' ),
				),
			);
		}
	}
